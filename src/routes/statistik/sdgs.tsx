...
const SdgsChart = lazy(() =>
    import('#/components/shared/chart/sdgs').then((m) => ({
        default: m.SdgsChart,
    })),
)
const ChartSkeleton = () => (
...
export const Route = createFileRoute('/statistik/sdgs')({
    ...
    loader: async ({ context }) => {
        const sdgs =
            await context.queryClient.ensureQueryData(sdgsQueryOptions())
        return {
            sdgs: sdgs,
        }
    },
        ...
        <main className="w-full">
                ...
                <div className="flex flex-col lg:flex-row gap-12 items-center">
                    <div className="flex-1">
                        ...
                        <p className="text-muted-foreground mt-6 text-lg max-w-2xl">
                            Sustainable Development Goals (SDGs) Desa adalah
                            upaya terpadu untuk mewujudkan desa tanpa
                            kemiskinan, tanpa kelaparan, dan desa ekonomi tumbuh
                            merata.
                        </p>
            ...
            <section className="px-4 lg:px-12 py-16 bg-background border-t border-border">
                <div className="bg-primary rounded-[2rem] p-12 text-white flex flex-col md:flex-row items-center gap-12 relative overflow-hidden">
                    <CheckCircle2
                        className="absolute -bottom-10 -left-10 w-48 h-48 text-white/10"
                        aria-hidden="true"
                    />
                    <div className="flex-1 z-10">
                        ...
                        <p className="text-white/80 leading-relaxed max-w-2xl text-lg">
                            Pemerintah Desa Sumberkejayan terus berupaya
                            mengintegrasikan tujuan-tujuan SDGs dalam setiap
                            kebijakan pembangunan desa. Kami percaya bahwa masa
                            depan yang lebih baik dimulai dari aksi nyata di
                            tingkat desa.
                        </p>
                    </div>
