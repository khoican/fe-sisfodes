    ...
    head: () => ({
        meta: [
            ...
            },
            {
                name: 'description',
                content:
                    'Data kependudukan Desa Sumberkejayan yang mencakup total penduduk, komposisi usia, tingkat pendidikan, dan persebaran wilayah.',
            },
        ],
    }),
    loader: async ({ context }) => {
        const population = await context.queryClient.ensureQueryData(
            ...
            <section className="bg-background px-4 lg:px-12 py-12 rounded-b-3xl border-b border-border">
                <div className="max-w-4xl">
                    ...
                    <h1 className="text-5xl font-extrabold leading-tight">
                        Statistik{' '}
                        <span className="text-primary">Kependudukan</span>
                    </h1>
                    <p className="text-muted-foreground mt-6 text-lg">
                        Data kependudukan yang akurat adalah fondasi perencanaan
                        pembangunan desa yang tepat sasaran. Informasi di bawah
                        ini mencerminkan kondisi riil masyarakat Desa
                        Sumberkejayan.
                    </p>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-12">
                    {stats.map((stat, idx) => (
                        <Card
                            key={idx}
                            className="border-none bg-primary/5 shadow-sm"
                        >
            ...
            <section className="px-4 lg:px-12 py-16 grid lg:grid-cols-2 gap-12">
                ...
                <Card className="border-none shadow-md overflow-hidden bg-card">
                    <CardHeader className="pb-0">
                        ...
                        <CardDescription>
                            Pengelompokan penduduk berdasarkan rentang usia
                            (Tahun).
                        </CardDescription>
                    </CardHeader>
                    <CardContent>
            ...
            <section className="px-4 lg:px-12 py-16 bg-muted/50 grid lg:grid-cols-2 gap-12">
                <div>
                    ...
                    <p className="text-sm text-muted-foreground mb-8">
                        Data jenjang pendidikan terakhir yang ditempuh oleh
                        penduduk desa.
                    </p>
                    <div className="space-y-6">
                        {population.by_education.map((item, idx) => (
                            <div
                                key={idx}
                                className="bg-card p-5 rounded-2xl shadow-sm border border-border flex items-center justify-between group hover:border-primary/30 transition-colors"
                            >
                                <div className="flex items-center gap-4">
                ...
                <div>
                    ...
                    <p className="text-sm text-muted-foreground mb-8">
                        Distribusi penduduk berdasarkan wilayah dusun atau
                        administratif desa.
                    </p>
                ...
                <div className="flex items-center gap-6">
                    ...
                    <div>
                        ...
                        <p className="text-muted-foreground text-sm">
                            Data kependudukan diperbarui secara otomatis setiap
                            semester.
                        </p>
                    </div>
                </div>
