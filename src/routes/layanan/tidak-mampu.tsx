...
export const Route = createFileRoute('/layanan/tidak-mampu')({
  head: () => ({
    meta: [
      ...
      {
        name: 'description',
        content: 'Permohonan Surat Keterangan Tidak Mampu (SKTM) secara online untuk warga Desa Sumberkejayan.',
      },
    ],
  }),
      ...
      <section className='bg-background px-4 lg:px-12 py-12 rounded-b-3xl border-b shadow-sm'>
        <div className='max-w-4xl'>
          ...
          <h1 className='text-5xl font-extrabold leading-tight'>
            Surat Keterangan <span className='text-primary'>Tidak Mampu</span>
          </h1>
          <p className='text-muted-foreground mt-6 text-lg'>
            Layanan ini diperuntukkan bagi warga Desa Sumberkejayan yang membutuhkan Surat Keterangan 
            Tidak Mampu (SKTM) untuk keperluan pendidikan, kesehatan, atau bantuan sosial lainnya.
          </p>
        </div>
      </section>
        ...
        {isSubmitted ? (
          <div className='bg-green-500/10 border border-green-500/20 rounded-3xl p-12 text-center animate-in zoom-in duration-300'>
            ...
            <p className='text-green-600/70 dark:text-green-400/70 mt-4 max-w-md mx-auto'>
              Terima kasih. Permohonan SKTM Anda telah kami terima. Tim verifikasi desa akan 
              melakukan peninjauan data sebelum surat dapat diterbitkan.
            </p>
            <Button 
              ...
              <form onSubmit={handleSubmit} className='space-y-8'>
                ...
                <div className='space-y-6 pt-6 border-t'>
                  <div className='flex items-center gap-2 text-primary font-bold'>
                    <Upload size={20} />
                    <h3 className='text-lg'>Dokumen Pendukung</h3>
                  </div>

                  <div className='space-y-4'>
                    <div className='space-y-2'>
                      <Label htmlFor='document'>Surat Pernyataan Tidak Mampu</Label>
                      <Input 
                        id='document' 
                        type='file' 
                      ...
                      />
                      <p className='text-xs text-muted-foreground'>Format file: PDF, JPG, atau PNG. Maksimal 2MB.</p>
                    </div>
                    ...
                    <div className='bg-amber-500/10 border border-amber-500/20 p-4 rounded-xl flex gap-3 text-amber-600 dark:text-amber-400 text-xs'>
                      ...
                      <p>
                        Unggah surat pernyataan tidak mampu yang telah ditandatangani oleh pemohon 
                        dan diketahui oleh Ketua RT/RW setempat sebagai syarat verifikasi.
                      </p>
                    </div>
                  </div>
                </div>
