...
export const Route = createFileRoute('/layanan/kehilangan')({
  head: () => ({
    meta: [
      ...
      {
        name: 'description',
        content: 'Permohonan Surat Keterangan Kehilangan secara online untuk warga Desa Sumberkejayan.',
      },
    ],
  }),
      ...
      <section className='bg-background px-4 lg:px-12 py-12 rounded-b-3xl border-b shadow-sm'>
        <div className='max-w-4xl'>
          ...
          <h1 className='text-5xl font-extrabold leading-tight'>
            Surat Keterangan <span className='text-primary'>Kehilangan</span>
          </h1>
          <p className='text-muted-foreground mt-6 text-lg'>
            Silakan lengkapi formulir di bawah ini untuk melaporkan kehilangan dokumen atau barang berharga. 
            Surat ini digunakan sebagai pengantar ke Kepolisian.
          </p>
        </div>
      </section>
      ...
      <section className='px-4 lg:px-12 py-16 max-w-5xl mx-auto'>
        {isSubmitted ? (
          <div className='bg-green-500/10 border border-green-500/20 rounded-3xl p-12 text-center animate-in zoom-in duration-300'>
            ...
            <h2 className='text-2xl font-bold text-green-600 dark:text-green-400'>Laporan Berhasil Dikirim!</h2>
            <p className='text-green-600/70 dark:text-green-400/70 mt-4 max-w-md mx-auto'>
              Terima kasih. Laporan kehilangan Anda telah kami terima. Silakan datang ke kantor desa 
              untuk mengambil surat fisik dengan membawa dokumen pendukung (jika ada).
            </p>
            <Button 
              ...
              <form onSubmit={handleSubmit} className='space-y-8'>
                ...
                <div className='grid md:grid-cols-2 gap-6'>
                  <div className='space-y-2'>
                    ...
                    <Input id='job' placeholder='Pekerjaan saat ini' required />
                  </div>
                  <div className='space-y-2'>
                    <Label htmlFor='address' className='flex items-center gap-2'>
                      <MapPin size={14} /> Alamat
                    </Label>
                    <Input id='address' placeholder='Alamat lengkap sesuai KTP' required />
                  </div>
                </div>
                ...
                <div className='space-y-6 pt-6 border-t'>
                  <div className='flex items-center gap-2 text-primary font-bold'>
                    ...
                    <h3 className='text-lg'>Detail Kehilangan</h3>
                  </div>

                  <div className='space-y-2'>
                    <Label htmlFor='loss_item'>Barang / Dokumen yang Hilang</Label>
                    <Textarea 
                      id='loss_item' 
                  ...
                  <div className='space-y-2'>
                    <Label htmlFor='loss_date' className='flex items-center gap-2'>
                      <Clock size={14} /> Perkiraan Waktu Hilang
                    </Label>
                    <Input id='loss_date' placeholder='Contoh: Senin, 12 Mei 2024 sekitar pukul 10:00 WIB' required />
                  </div>
                </div>
