    ...
    head: () => ({
        meta: [
            ...
            },
            {
                name: 'description',
                content:
                    'Permohonan Surat Keterangan Domisili secara online untuk warga Desa Sumberkejayan.',
            },
        ],
    }),
            ...
            <section className="bg-background px-4 lg:px-12 py-12 rounded-b-3xl border-b shadow-sm">
                <div className="max-w-4xl">
                    ...
                    <h1 className="text-5xl font-extrabold leading-tight">
                        Surat Keterangan{' '}
                        <span className="text-primary">Domisili</span>
                    </h1>
                    <p className="text-muted-foreground mt-6 text-lg">
                        Silakan lengkapi formulir di bawah ini untuk mengajukan
                        permohonan Surat Keterangan Domisili. Pastikan data yang
                        Anda masukkan sesuai dengan KTP/KK yang berlaku.
                    </p>
                </div>
            </section>
                ...
                {isSubmitted ? (
                    <div className="bg-green-500/10 border border-green-500/20 rounded-3xl p-12 text-center animate-in zoom-in duration-300">
                        ...
                        <p className="text-green-600/70 dark:text-green-400/70 mt-4 max-w-md mx-auto">
                            Terima kasih. Permohonan Surat Keterangan Domisili
                            Anda telah kami terima dan akan segera diproses oleh
                            staf desa. Kami akan menghubungi Anda melalui nomor
                            yang terdaftar.
                        </p>
                        <Button
                        ...
                        <CardContent className="p-8">
                            ...
                            <form onSubmit={handleSubmit} className="space-y-8">
                                ...
                                <div className="space-y-2">
                                    ...
                                    <Input
                                        id="job"
                                        placeholder="Contoh: Petani / Karyawan Swasta"
                                        required
                                    />
                                </div>
