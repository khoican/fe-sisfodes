    ...
    head: () => ({
        meta: [
            ...
            },
            {
                name: 'description',
                content:
                    'Permohonan Surat Keterangan Pindah Kawin / Numpang Nikah secara online untuk warga Desa Sumberkejayan.',
            },
        ],
    }),
            ...
            <section className="bg-background px-4 lg:px-12 py-12 rounded-b-3xl border-b shadow-sm">
                <div className="max-w-4xl">
                    ...
                    <h1 className="text-5xl font-extrabold leading-tight">
                        Surat Keterangan{' '}
                        <span className="text-primary">Pindah Kawin</span>
                    </h1>
                    <p className="text-muted-foreground mt-6 text-lg">
                        Layanan permohonan surat keterangan untuk keperluan
                        pernikahan di luar wilayah Desa Sumberkejayan (Pindah
                        Nikah atau Numpang Nikah).
                    </p>
                </div>
            </section>
                ...
                {isSubmitted ? (
                    <div className="bg-green-500/10 border border-green-500/20 rounded-3xl p-12 text-center animate-in zoom-in duration-300">
                        ...
                        <p className="text-green-600/70 dark:text-green-400/70 mt-4 max-w-md mx-auto">
                            Terima kasih. Permohonan surat keterangan pindah
                            kawin Anda telah kami terima. Silakan lengkapi
                            berkas fisik di kantor desa untuk proses
                            penandatanganan lebih lanjut.
                        </p>
                        <Button
                                ...
                                <div className="space-y-6">
                                    ...
                                    <div className="grid md:grid-cols-2 gap-6">
                                        ...
                                        <div className="space-y-2">
                                            ...
                                            <Input
                                                id="address"
                                                placeholder="Alamat di Desa Sumberkejayan"
                                                required
                                            />
                                        </div>
                                    </div>
                                ...
                                <div className="space-y-6 pt-6">
                                    ...
                                    <div className="space-y-2">
                                        <Label htmlFor="destination">
                                            Alamat Tujuan (Tempat Menikah)
                                        </Label>
                                        <Input
                                            id="destination"
                                            placeholder="Desa/Kel, Kec, Kab/Kota tujuan"
                                            required
                                        />
                                    </div>
                                    ...
                                    <div className="grid md:grid-cols-2 gap-6">
                                        <div className="space-y-2">
                                            ...
                                            <Select required>
                                                ...
                                                <SelectContent>
                                                    <SelectItem value="pindah nikah">
                                                        Pindah Nikah
                                                    </SelectItem>
                                                    <SelectItem value="numpang nikah">
                                                        Numpang Nikah
                                                    </SelectItem>
                                                </SelectContent>
                                            </Select>
