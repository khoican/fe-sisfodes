    ...
    head: () => ({
        meta: [
            ...
            },
            {
                name: 'description',
                content:
                    'Sampaikan aspirasi, keluhan, atau laporan Anda secara resmi melalui sistem pengaduan masyarakat Desa Sumberkejayan.',
            },
        ],
    }),
    ...
    const complaintFlow = [
        {
            title: 'Kirim Laporan',
            description:
                'Isi formulir pengaduan dengan data yang valid dan sampaikan keluhan Anda secara jelas.',
            icon: MessageSquare,
        },
        {
            title: 'Verifikasi',
            description:
                'Tim admin desa akan memverifikasi laporan Anda untuk memastikan validitas data.',
            icon: ShieldCheck,
        },
        {
            title: 'Tindak Lanjut',
            description:
                'Laporan akan diteruskan ke pihak terkait untuk segera mendapatkan penanganan.',
            icon: Send,
        },
        {
            title: 'Selesai',
            description:
                'Status pengaduan akan diinformasikan kembali kepada pelapor melalui kontak yang terdaftar.',
            icon: CheckCircle2,
        },
    ]
            ...
            <section className="bg-background px-4 lg:px-12 py-12 rounded-b-3xl border-b shadow-sm">
                <div className="max-w-4xl">
                    ...
                    <p className="text-muted-foreground mt-6 text-lg">
                        Pemerintah Desa Sumberkejayan berkomitmen untuk
                        mendengar dan menindaklanjuti setiap aspirasi serta
                        keluhan warga demi pelayanan publik yang lebih baik.
                    </p>
                </div>
            </section>
                ...
                <div className="grid lg:grid-cols-3 gap-12">
                        ...
                        {isSubmitted ? (
                            <div className="mt-8 bg-green-500/10 border border-green-500/20 rounded-3xl p-12 text-center animate-in zoom-in duration-300">
                                ...
                                <p className="text-green-600/70 dark:text-green-400/70 mt-4 max-w-md mx-auto">
                                    Terima kasih atas laporan Anda. Tim kami
                                    akan segera meninjau dan menindaklanjuti
                                    pengaduan tersebut. Nomor tiket laporan
                                    telah dikirim ke kontak Anda.
                                </p>
                                <Button
                                    ...
                                    >
                                        ...
                                        <div className="bg-amber-500/10 border border-amber-500/20 p-4 rounded-xl flex gap-3 text-amber-600 dark:text-amber-400 text-sm">
                                            ...
                                            <p>
                                                ...
                                                benar. Laporan palsu atau
                                                penyalahgunaan layanan dapat
                    ...
                    <div className="space-y-8">
                        <div className="bg-primary text-white p-8 rounded-3xl shadow-xl shadow-primary/20 relative overflow-hidden">
                            ...
                            <div className="relative z-10">
                                ...
                                <p className="text-white/80 text-sm leading-relaxed mb-8">
                                    Untuk situasi darurat yang membutuhkan
                                    penanganan segera, silakan hubungi nomor di
                                    bawah ini:
                                </p>
                        ...
                        <div className="bg-card p-8 rounded-3xl border shadow-sm space-y-8">
                            ...
                            <div className="space-y-6">
                                <div className="flex gap-4">
                                    ...
                                    />
                                    <div>
                                        <p className="text-xs font-bold text-muted-foreground/70 uppercase tracking-widest mb-1">
                                            Alamat Kantor
                                        </p>
                                        <p className="text-sm text-muted-foreground leading-relaxed">
                                            {profil.address.address},{' '}
                                            {profil.address.village}, Kec.{' '}
                                            {profil.address.district},{' '}
                                            {profil.address.regency}
                                        </p>
                                    </div>
                                </div>
                        ...
                        <div className="bg-muted p-6 rounded-2xl border border-dashed border-border">
                            <p className="text-xs text-muted-foreground leading-relaxed">
                                <strong>Catatan:</strong> Pengaduan Anda akan
                                diproses dalam waktu maksimal 3x24 jam kerja
