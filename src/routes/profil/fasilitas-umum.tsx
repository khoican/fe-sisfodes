    ...
    head: () => ({
        meta: [
            ...
            },
            {
                name: 'description',
                content:
                    'Daftar fasilitas umum yang tersedia di Desa Sumberkejayan mulai dari pendidikan, kesehatan, hingga sarana olahraga.',
            },
        ],
    }),
            ...
            <section className="grid md:grid-cols-8 gap-10 items-center bg-card px-4 lg:px-12 pb-8 pt-8 rounded-b-xl border-b border-border shadow-sm">
                <div className="w-full md:col-span-5">
                    ...
                    <h1 className="text-4xl lg:text-6xl font-extrabold leading-tight text-foreground">
                        Fasilitas <span className="text-primary">Publik</span>{' '}
                        Kami
                    </h1>
                    <p className="text-sm md:text-lg text-muted-foreground mt-4 max-w-2xl">
                        Pemerintah Desa Sumberkejayan berkomitmen menyediakan
                        sarana dan prasarana yang memadai untuk mendukung
                        produktivitas, kesehatan, dan kesejahteraan seluruh
                        warga.
                    </p>
                </div>
                ...
                {filteredFacilities.length === 0 && (
                    <div className="w-full py-20 flex flex-col items-center text-center">
                        ...
                        <p className="text-muted-foreground mt-2">
                            Maaf, fasilitas yang Anda cari tidak tersedia dalam
                            kategori ini.
                        </p>
                    </div>
                )}
            ...
            <section className="w-full bg-primary p-12 lg:px-24 flex flex-col md:flex-row items-center justify-between gap-8 border-none">
                <div className="text-white">
                    ...
                    <p className="text-white/80 mt-2 max-w-xl text-lg">
                        Jika Anda memiliki pertanyaan mengenai penggunaan
                        fasilitas desa atau ingin melaporkan kerusakan sarana
                        publik, silakan hubungi kantor desa.
                    </p>
                </div>
