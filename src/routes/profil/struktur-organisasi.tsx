    ...
    head: () => ({
        meta: [
            ...
            },
            {
                name: 'description',
                content:
                    'Mengenal perangkat desa dan struktur organisasi Pemerintah Desa Sumberkejayan periode berjalan.',
            },
        ],
    }),
    loader: async ({ context }) => {
        const official = await context.queryClient.ensureQueryData(
...
function StrukturOrganisasi() {
    ...
    const staffLainnya = official.filter(
        (item) =>
    ...
    return (
        <main className="w-full px-4 lg:px-12 py-8">
            <section className="w-full lg:w-1/2 py-16 flex flex-col gap-4">
                <Badge
                    variant="primary"
                    className="w-fit uppercase tracking-wider px-4"
                >
                    Pemerintahan Desa
                </Badge>
                <h1 className="text-6xl font-bold">Struktur Organisasi</h1>
                <p className="text-gray-600 mt-2">
                    Susunan organisasi Pemerintah Desa Sumberkejayan yang
                    bertugas melayani masyarakat dan menjalankan roda
                    pemerintahan desa dengan penuh integritas.
                </p>
            </section>
            ...
            <section className="w-full flex flex-col gap-12 items-center mb-16">
                ...
                {kepalaDesa && (
                    <div className="w-full max-w-sm">
                        <h2 className="text-center text-xl font-bold mb-6 text-primary uppercase tracking-widest">
                            Kepala Desa
                        </h2>
                ...
                <div className="w-full">
                    <h2 className="text-center text-xl font-bold mb-12 text-primary uppercase tracking-widest">
                        Perangkat Desa
                    </h2>
            ...
            <section className="w-full bg-primary/5 rounded-2xl p-12 mt-16 flex flex-col items-center text-center gap-6">
                ...
                <p className="max-w-2xl text-gray-600 leading-relaxed">
                    ...
                    akuntabel, dan mengutamakan kepentingan masyarakat dalam
                    setiap proses pembangunan dan pelayanan."
                </p>
            </section>
        </main>
    )
