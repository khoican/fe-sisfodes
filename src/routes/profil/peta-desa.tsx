    ...
    <main className='w-full bg-background'>
          ...
          <div className='lg:col-span-1 flex flex-col gap-6'>
            <div className='bg-card p-6 rounded-2xl border border-border shadow-sm'>
              <div className='flex items-center gap-2 mb-4 text-primary'>
                ...
                <h2 className='font-bold text-foreground'>Panduan Peta</h2>
              </div>
            ...
            <div className='bg-primary/5 p-6 rounded-2xl border border-primary/10'>
              <h2 className='font-bold mb-3 text-foreground'>Daftar Titik</h2>
              <div className='max-h-[40vh] overflow-y-auto pr-2 custom-scrollbar'>
                {facilities.map((f) => (
                  <div key={f.id} className='py-3 border-b border-border last:border-none'>
      ...
      <section className='w-full bg-card border-t border-border p-12 lg:px-24 mt-8'>
        <div className='grid md:grid-cols-3 gap-12'>
          <div>
            <h2 className='font-bold text-lg mb-4 text-foreground'>Akurasi Data</h2>
          ...
          <div>
            <h2 className='font-bold text-lg mb-4 text-foreground'>Integrasi Sistem</h2>
            <p className='text-sm text-muted-foreground leading-relaxed'>
          ...
          <div>
            <h2 className='font-bold text-lg mb-4 text-foreground'>Penggunaan Publik</h2>
            <p className='text-sm text-muted-foreground leading-relaxed'>
