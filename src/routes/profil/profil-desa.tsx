    ...
    head: () => ({
        meta: [
            ...
            },
            {
                name: 'description',
                content:
                    'Pelajari sejarah, visi, misi, dan struktur organisasi Pemerintah Desa Sumberkejayan.',
            },
        ],
    }),
            ...
            <section className="grid md:grid-cols-8 gap-10 items-center bg-white dark:bg-gray-950 px-4 lg:px-12 pb-8 pt-8 rounded-b-xl">
                <div className="w-full md:col-span-5">
                    <h1 className="text-6xl font-extrabold">
                        Mengenal <span className="text-primary">Luhurnya</span>{' '}
                        Sejarah Kami
                    </h1>
                    <p className="text-sm md:text-lg text-gray-600 mt-4">
                        Desa Sumberkejayan bukan sekadar titik geografis,
                        melainkan warisan peradaban yang terus tumbuh dalam
                        harmoni antara nilai leluhur dan modernitas digital.
                    </p>
                </div>
            ...
            <section className="px-4 lg:px-12 bg-primary mt-24 relative h-full overflow-hidden py-12">
                ...
                <div className="text-white grid lg:grid-cols-2 gap-8">
                    <div>
                        ...
                        <p className="text-lg md:text-2xl italic mt-6">
                            "{vision}"
                        </p>
                    </div>
                    <div>
                        <h3 className="text-4xl font-extrabold tracking-wider">
                            MISI
                        </h3>
                        ...
                        {mission.map((item: string, index: number) => (
                            <div
                                key={index}
                                className="text-md mt-4 flex items-start gap-4"
                            >
