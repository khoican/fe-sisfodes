    ...
    head: () => ({
        meta: [
            ...
            },
            {
                name: 'description',
                content:
                    'Informasi mengenai letak geografis, luas wilayah, topografi, dan tata guna lahan Desa Sumberkejayan.',
            },
        ],
    }),
    loader: async ({ context }) => {
        const geography = await context.queryClient.ensureQueryData(
        ...
        <main className="w-full">
            ...
            <section className="grid md:grid-cols-8 gap-10 items-center bg-white px-4 lg:px-12 pb-8 pt-8 rounded-b-xl">
                <div className="w-full md:col-span-5">
                    ...
                    <h1 className="text-6xl font-extrabold leading-tight">
                        Bentang <span className="text-primary">Alam</span> &
                        Geografi
                    </h1>
                    <p className="text-sm md:text-lg text-gray-600 mt-4 max-w-2xl">
                        Eksplorasi karakteristik fisik Desa Sumberkejayan, mulai
                        dari luas wilayah, kondisi topografi yang subur, hingga
                        pembagian tata guna lahan yang mendukung keberlanjutan.
                    </p>
                </div>
                        ...
                        <div className="flex items-center gap-4 mb-8">
                            ...
                            <div>
                                ...
                                <p className="text-sm text-gray-500">
                                    Distribusi penggunaan wilayah desa
                                </p>
                            </div>
                        </div>
            ...
            <section className="w-full bg-primary/5 rounded-t-3xl p-12 flex flex-col items-center text-center gap-6">
                ...
                <p className="max-w-2xl text-gray-600 leading-relaxed">
                    Kondisi geografis yang strategis dengan dominasi lahan
                    pertanian{' '}
                    {
                        geography.land_use.find(
                            (l) => l.label === 'Lahan Pertanian',
                        )?.percentage
                    }
                    % menjadikan Desa Sumberkejayan sebagai lumbung pangan
                    potensial yang terus dikembangkan melalui modernisasi tata
                    kelola lahan.
                </p>
            </section>
        </main>
