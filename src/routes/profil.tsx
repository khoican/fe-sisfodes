  ...
  return (
    <main className=''>
      <section className='grid md:grid-cols-8 gap-10 items-center bg-white px-4 lg:px-12 pb-8 pt-8'>
        ...
        <div className='col-span-3 h-[60vh] relative rounded-2xl overflow-hidden'>
          <Image
      ...
      <section className='mt-16 px-4 lg:px-12'>
        ...
        <div className='grid grid-cols-3 gap-6 mt-6'>
          ...
          <div className='col-span-2 bg-white rounded-2xl shadow p-8 border-b-6 border-primary'>
      ...
      <section className='px-4 lg:px-12 bg-primary mt-24 relative h-full overflow-hidden py-12'>
        ...
        <div className='text-white grid grid-cols-2 gap-8'>
          <div>
            ...
            <h3 className='text-8xl font-extrabold tracking-wider mt-8'>
              VISI
            </h3>

            <p className='text-2xl italic mt-6'>"{vision.content}"</p>
          </div>
          <div>
      ...
      <section className='mt-16 px-4 lg:px-12 py-8 lg:py-16'>
        ...
        <p className='text-center text-gray-600 mt-4 text-sm w-1/3 mx-auto'>
