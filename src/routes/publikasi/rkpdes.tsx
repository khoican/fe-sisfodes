...
export const Route = createFileRoute('/publikasi/rkpdes')({
  head: () => ({
    meta: [
      ...
      {
        name: 'description',
        content: 'Rencana Kerja Pemerintah Desa (RKPDes) Sumberkejayan. Dokumen perencanaan tahunan desa.',
      },
    ],
  }),
  loader: async ({ context }) => {
    const publication = await context.queryClient.ensureQueryData(publicationQueryOptions('rkpdes'))
    return {
    ...
    <main className='w-full'>
      ...
      <section className='bg-background px-4 lg:px-12 py-12 rounded-b-3xl border-b shadow-sm'>
        <div className='max-w-4xl'>
          <Badge variant='primary' className='mb-4 uppercase tracking-widest'>Dokumen Perencanaan</Badge>
          <h1 className='text-5xl font-extrabold leading-tight'>
            RKP<span className='text-primary'>Des</span>
          </h1>
          <p className='text-muted-foreground mt-6 text-lg'>
            Rencana Kerja Pemerintah Desa (RKPDes) merupakan dokumen penjabaran dari RPJM Desa 
            untuk jangka waktu 1 (satu) tahun yang memuat rancangan kerangka ekonomi desa.
          </p>
        </div>
      </section>
          ...
          <div className='lg:col-span-1 space-y-6'>
            ...
            <div className='bg-amber-500/10 border border-amber-500/20 p-6 rounded-2xl flex gap-4 mt-8'>
              ...
              <p className='text-xs text-amber-700 leading-relaxed'>
                Dokumen yang diunggah adalah salinan resmi. Untuk mendapatkan salinan fisik bertanda tangan 
            ...
            <Card className='border-none shadow-xl shadow-muted/10 rounded-3xl overflow-hidden bg-muted min-h-[600px] flex flex-col'>
               ...
               <div className='flex-1 relative bg-muted flex items-center justify-center p-8'>
                  ...
                  <div className='text-center max-w-sm'>
                     ...
                     <h3 className='font-bold text-lg'>Siap untuk Dibaca</h3>
                     <p className='text-muted-foreground text-sm mt-2 mb-8'>
                        Dokumen dapat dilihat langsung atau diunduh untuk dibaca secara luring. 
                        Pratinjau interaktif akan terbuka di jendela baru.
                     </p>
                     <Button asChild className='rounded-xl px-8'>
                        <a href={selectedDoc.file_url} target='_blank' rel='noopener noreferrer'>
                           <ExternalLink className='mr-2 h-4 w-4' /> Buka Dokumen Penuh
                        </a>
                     </Button>
                  </div>
