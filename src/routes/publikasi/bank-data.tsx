    ...
    head: () => ({
        meta: [
            ...
            },
            {
                name: 'description',
                content:
                    'Pusat data dan dokumen publik Desa Sumberkejayan. Download peraturan desa, formulir, dan laporan resmi.',
            },
        ],
    }),
...
function BankDataPage() {
    ...
    const filteredDocs = publication.documents.filter(
        (doc) =>
            ...
            <section className="bg-background px-4 lg:px-12 py-12 rounded-b-3xl border-b shadow-sm">
                <div className="max-w-4xl">
                    ...
                    <p className="text-muted-foreground mt-6 text-lg">
                        Pusat penyimpanan dokumen digital Desa Sumberkejayan.
                        Temukan dan unduh berbagai regulasi, formulir layanan,
                        dan laporan publik secara mudah.
                    </p>
                </div>
            </section>
                    ...
                    {filteredDocs.length > 0 ? (
                        ...
                        <div className="py-20 text-center bg-muted/30 rounded-3xl border border-dashed border-border">
                            ...
                            <p className="text-muted-foreground font-medium">
                                Tidak ada dokumen yang ditemukan untuk kata
                                kunci tersebut.
                            </p>
                            <Button
                                variant="ghost"
            ...
            <section className="px-4 lg:px-12 py-16 bg-muted/30">
                <div className="max-w-4xl mx-auto text-center">
                    ...
                    <p className="text-muted-foreground leading-relaxed">
                        Seluruh dokumen yang dipublikasikan di Bank Data
                        merupakan informasi terbuka yang dapat diakses oleh
                        publik sesuai dengan Undang-Undang Keterbukaan Informasi
                        Publik. Jika Anda membutuhkan informasi lain yang belum
                        tersedia di sini, silakan ajukan permohonan informasi
                        melalui formulir pengaduan atau datang langsung ke
                        kantor desa.
                    </p>
                </div>
            </section>
