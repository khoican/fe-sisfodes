    ...
    head: () => ({
        meta: [
            ...
            },
            {
                name: 'description',
                content:
                    'Transparansi Anggaran Pendapatan dan Belanja Desa (APBDes) Sumberkejayan tahun anggaran berjalan.',
            },
        ],
    }),
...
function ApbdesPage() {
    ...
    const comparisonData = useMemo(
        () => [
            {
                name: 'Pendapatan',
                direncanakan: budget.income.total_planned,
                terealisasi: budget.income.total_realized,
            },
            {
                name: 'Belanja',
                direncanakan: budget.expenditure.total_planned,
                terealisasi: budget.expenditure.total_realized,
            },
        ],
        [budget],
    )
                ...
                <div className="flex flex-col lg:flex-row gap-12 items-center">
                    <div className="flex-1">
                        ...
                        <p className="text-gray-600 mt-6 text-lg max-w-2xl">
                            Wujud keterbukaan informasi publik Pemerintah Desa
                            Sumberkejayan dalam pengelolaan keuangan desa untuk
                        ...
                        <div className="flex flex-wrap gap-4 mt-8 text-xs text-gray-400">
                            ...
                            <div className="flex items-center gap-2">
                                ...
                                <span>
                                    Sumber Data: Sistem Informasi Keuangan Desa
                                    (Siskeudes)
                                </span>
                            </div>
                        </div>
                        ...
                        <Card className="bg-primary border-none shadow-xl shadow-primary/20 text-white">
                            <CardContent className="pt-6">
                                ...
                                <p className="text-2xl font-black">
                                    {formatCurrency(
                                        budget.expenditure.total_planned,
                                    )}
                                </p>
                                <div className="mt-4 pt-4 border-t border-white/10 flex justify-between items-center">
                                    <span className="text-[10px] opacity-70">
                                        Realisasi:{' '}
                                        {Math.round(
                                            (budget.expenditure.total_realized /
                                                budget.expenditure
                                                    .total_planned) *
                                                100,
                                        )}
                ...
                <div>
                    ...
                    <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
                        {budget.income.items.map((item) => (
                            <Card
                                key={item.id}
                                className="border-none shadow-md overflow-hidden bg-white group"
                            >
                                ...
                                <CardContent className="space-y-4">
                                    ...
                                    <div className="pt-4 border-t border-dashed">
                                        <div className="flex justify-between items-center mb-1">
                                            ...
                                            <span
                                                className={`text-xs font-bold ${getPercentageColor(item.percentage)}`}
                                            >
                                                {item.percentage}%
                                            </span>
                                        </div>
                ...
                <div>
                    <div className="flex items-center gap-3 mb-8">
                        ...
                        <div>
                            ...
                            <p className="text-sm text-gray-500">
                                Alokasi pengeluaran untuk pembangunan dan
                                pelayanan.
                            </p>
                        </div>
                    </div>
                    ...
                    <div className="grid md:grid-cols-2 gap-6">
                        {budget.expenditure.items.map((item) => (
                            <Card
                                key={item.id}
                                className="border-none shadow-md bg-white hover:border-emerald-500/30 transition-all"
                            >
            ...
            <section className="w-full bg-primary p-12 lg:p-20 flex flex-col md:flex-row items-center gap-12 relative overflow-hidden mt-16">
                ...
                <div className="flex-1 z-10">
                    ...
                    <p className="text-white/80 mt-4 leading-relaxed max-w-2xl">
                        Masyarakat berhak mengetahui, mengawasi, dan memberikan
                        masukan terkait pengelolaan keuangan desa. Jika Anda
                        menemukan ketidaksesuaian atau memiliki pertanyaan,
                        silakan hubungi kami melalui layanan pengaduan resmi.
                    </p>
                </div>
