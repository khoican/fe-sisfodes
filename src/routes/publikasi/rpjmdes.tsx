    ...
    head: () => ({
        meta: [
            ...
            },
            {
                name: 'description',
                content:
                    'Rencana Pembangunan Jangka Menengah Desa (RPJMDes) Sumberkejayan. Dokumen perencanaan strategis 6 tahunan desa.',
            },
        ],
    }),
            ...
            <section className="bg-background px-4 lg:px-12 py-12 rounded-b-3xl border-b shadow-sm">
                <div className="max-w-4xl">
                    ...
                    <p className="text-muted-foreground mt-6 text-lg">
                        ...
                        adalah dokumen perencanaan kegiatan pembangunan desa
                    ...
                    <div className="lg:col-span-1 space-y-6">
                        ...
                        <div className="bg-indigo-500/10 border border-indigo-500/20 p-6 rounded-2xl flex gap-4 mt-8">
                            ...
                            <p className="text-xs text-indigo-700 leading-relaxed">
                                RPJMDes memuat visi misi Kepala Desa dan arah
                                kebijakan pembangunan desa yang berorientasi
                                pada pemenuhan kebutuhan dasar masyarakat.
                            </p>
                        </div>
                    </div>
                            ...
                            <div className="flex-1 relative bg-muted flex items-center justify-center p-8">
                                <div className="text-center max-w-sm">
                                    ...
                                    <h3 className="font-bold text-lg">
                                        Dokumen Strategis 6 Tahunan
                                    </h3>
                                    <p className="text-muted-foreground text-sm mt-2 mb-8">
                                        Pelajari arah pembangunan desa jangka
                                        menengah melalui dokumen ini. Silakan
                                        unduh untuk akses penuh di perangkat
                                        Anda.
                                    </p>
