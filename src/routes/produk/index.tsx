    ...
    head: () => ({
        meta: [
            ...
            },
            {
                name: 'description',
                content:
                    'Jelajahi berbagai produk unggulan dan potensi UMKM dari Desa Sumberkejayan.',
            },
        ],
    }),
        ...
        <main className="w-full px-4 lg:px-12 py-8 bg-background">
            <section className="w-full lg:w-1/2 py-16 flex flex-col gap-4">
                ...
                <p className="text-muted-foreground mt-2 text-lg">
                    Mendukung ekonomi lokal melalui produk-produk berkualitas
                    hasil karya masyarakat Desa Sumberkejayan.
                </p>
            </section>
