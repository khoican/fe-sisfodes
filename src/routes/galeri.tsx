    ...
    head: () => ({
        meta: [
            ...
            },
            {
                name: 'description',
                content:
                    'Koleksi dokumentasi visual kegiatan, pembangunan, dan pesona alam Desa Sumberkejayan.',
            },
        ],
    }),
        ...
        <main className="w-full bg-background">
            ...
            <section className="bg-card px-4 lg:px-12 py-12 rounded-b-3xl border-b shadow-sm">
                <div className="max-w-4xl">
                    ...
                    <p className="text-muted-foreground mt-6 text-lg">
                        Menyaksikan jejak perkembangan dan keindahan Desa
                ...
                <div className="columns-1 md:columns-2 lg:columns-3 gap-6 space-y-6">
                    {filteredGallery.map((item) => (
                        <div
                            ...
                            onKeyDown={(e) =>
                                e.key === 'Enter' && setSelectedImage(item)
                            }
                        >
                            <Image
                                src={item.image}
            ...
            <section className="w-full bg-primary/5 p-12 lg:p-20 flex flex-col items-center text-center gap-6 rounded-t-3xl border-t border-border">
                ...
                <p className="max-w-2xl text-muted-foreground leading-relaxed">
                    Punya foto atau video menarik tentang kegiatan di Desa
                    Sumberkejayan? Kirimkan karya Anda ke tim admin desa untuk
                    ditampilkan di halaman galeri ini.
                </p>
