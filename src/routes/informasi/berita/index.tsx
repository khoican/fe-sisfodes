...
function Berita () {
  ...
  return (
    <main className='w-full px-4 lg:px-12 py-8 bg-background'>
      ...
      <section className='relative w-full bg-primary mt-12 p-12 rounded-lg flex flex-col md:flex-row items-start md:items-center justify-between gap-6 border-none overflow-hidden'>
        <div className='w-40 h-40 rounded-full bg-white/10 absolute -top-10 -left-12' />
        <div className='w-20 h-20 rounded-full bg-white/10 absolute -bottom-10 -right-4' />
        ...
        <Button asChild variant='secondary' size='lg' className='text-primary relative z-10'>
          <Link to='/berita/pengumuman'>Lihat Pengumuman</Link>
        </Button>
      </section>

      <section className='w-full mt-16'>
        <h2 className='text-2xl font-bold text-foreground'>Semua Berita</h2>
