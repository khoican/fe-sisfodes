        ...
        <main className="w-full px-4 lg:px-12 py-8 bg-background">
            <section className="w-full lg:w-1/2 py-16 flex flex-col gap-6">
                ...
                <p className="text-muted-foreground text-lg">
                    Menyajikan kabar terpercaya, kebijakan terbaru, dan cerita
                    inspiratif dari jantung Desa Sumberkejayan untuk masyarakat
                    yang lebih berdaya.
                </p>
            </section>
            ...
            <section className="relative w-full bg-primary mt-12 p-12 rounded-lg flex flex-col md:flex-row items-start md:items-center justify-between gap-6 border-none overflow-hidden">
                ...
                <div className="flex flex-col gap-4 relative z-10">
                    ...
                    <p className="text-white/80 text-sm max-w-xl">
                        Untuk melihat pengumuman terbaru dari Pemerintah Desa
                        Sumberkejayan, silakan klik tombol{' '}
            ...
            <section className="w-full mt-16">
                ...
                <p className="text-muted-foreground mt-2">
                    Temukan berita terbaru dari Desa Sumberkejayan yang akan
                    membantu Anda tetap informasi.
                </p>
