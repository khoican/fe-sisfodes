...
export const artikelData: INews[] = [
    {
        ...
        description:
            'Artikel edukasi mengenai cara sederhana menjaga keasrian lingkungan desa demi kesehatan bersama.',
        content: `
    ...
    `,
        images: ['https://ik.imagekit.io/rulls/sisfodes/demo/news/inovasi-pengolahan-sampah-menjadi-pupuk-organik.jpg?tr-f=webp'],
    ...
    },
    {
        ...
        description:
            'Panduan praktis bagi petani desa yang ingin beralih ke pertanian organik yang lebih ramah lingkungan.',
        content: `
      ...
      <p>Kunci utama budidaya padi organik adalah pada persiapan lahan and penggunaan benih unggul. Selain itu, pengendalian hama menggunakan pestisida nabati juga sangat menentukan keberhasilan panen.</p>
    ...
    `,
        images: ['https://ik.imagekit.io/rulls/sisfodes/demo/news/panen-raya-padi-organik-desa-sukamaju.jpg?tr-f=webp'],
