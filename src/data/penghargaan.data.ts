...
export const penghargaanData: News[] = [
  {
    ...
    description: 'Penghargaan atas keberhasilan Desa Sumberkejayan dalam mengelola potensi lokal secara mandiri.',
    content: `
  ...
  },
  {
    ...
    description: 'Apresiasi terhadap upaya pelestarian budaya tradisional yang dikemas dalam paket wisata edukasi.',
    content: `
