...
export const events: Event[] = [
  {
    id: 1,
    slug: 'festival-budaya-bersih-desa',
    title: 'Festival Budaya Bersih Desa',
    description:
      'Festival tahunan warga sebagai wujud syukur panen, dimeriahkan kirab tumpeng, seni tradisional, dan doa bersama.',
    content:
    ...
    category: { id: 1, name: 'Agenda Desa' },
    source: { id: 1, name: 'Pemerintah Desa' },
    date: new Date('2026-05-10T08:00:00Z'),
    time: '08.00 - 12.00 WIB',
    location: 'Lapangan Desa',
    author: 'Panitia Budaya',
    created_at: new Date('2026-04-18T09:00:00Z')
  },
  {
    id: 2,
    slug: 'musyawarah-perencanaan-pembangunan-musrenbang',
    title: 'Musyawarah Perencanaan Pembangunan (Musrenbang)',
    description:
      'Forum warga untuk menyampaikan aspirasi dan menyusun prioritas pembangunan desa tahun anggaran mendatang.',
    content:
  ...
  {
    id: 3,
    slug: 'pelatihan-it-untuk-perangkat-desa',
    title: 'Pelatihan IT untuk Perangkat Desa',
    description:
      'Pelatihan intensif aplikasi perkantoran dan sistem informasi desa untuk mempercepat layanan administrasi warga.',
    content:
  ...
  {
    id: 4,
    slug: 'jalan-sehat-dan-cek-kesehatan-gratis',
    title: 'Jalan Sehat dan Cek Kesehatan Gratis',
    description:
      'Jalan sehat untuk semua usia, dilanjut cek kesehatan gratis bersama Puskesmas dan pembagian doorprize.',
    content:
  ...
  {
    id: 5,
    slug: 'sosialisasi-keamanan-lingkungan-siskamling',
    title: 'Sosialisasi Keamanan Lingkungan (Siskamling)',
    description:
      'Sosialisasi revitalisasi siskamling, pengaktifan ronda malam, dan koordinasi pelaporan demi lingkungan desa yang aman.',
    content:
    ...
    location: 'Balai Desa',
    author: 'Keamanan Desa',
    created_at: new Date('2026-04-15T11:00:00Z')
  },
  {
    id: 6,
    slug: 'lomba-masak-olahan-pangan-lokal',
    title: 'Lomba Masak Olahan Pangan Lokal',
    description:
      'Lomba masak untuk menggali kreativitas olahan pangan lokal; hasil karya akan dipromosikan lewat katalog UMKM desa.',
    content:
