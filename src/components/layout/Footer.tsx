        ...
        <footer className="mt-20 grid md:grid-cols-2 lg:grid-cols-4 gap-8 p-12 bg-card text-card-foreground border-t">
            <div>
                <Image
                    ...
                    alt="logo"
                    layout="fullWidth"
                    className="w-1/2 dark:brightness-0 dark:invert"
                />

                <p className="mt-8 text-sm text-muted-foreground font-medium tracking-wider">
                    Melayani warga dengan sepenuh hati, membangun kemandirian
                    ekonomi dari potensi lokal yang berkelanjutan.
                </p>
                ...
                <div className="w-full flex items-center gap-4 mt-6">
                    <Socmed
                        ...
                        label="Kunjungi Facebook Desa"
                    />
                    <Socmed
                        icon={FaInstagram}
                        link="https://www.instagram.com/"
                        label="Kunjungi Instagram Desa"
                    />
                    <Socmed
                        icon={FaTiktok}
                        link="https://www.tiktok.com/"
                        label="Kunjungi Tiktok Desa"
                    />
                </div>
            </div>
